<?php echo $Header ?>
    ...
    <header class="jumbotron masthead">
        ...
        <h1>ypCore CMS <span class="red" style="font-size: 0.4em">openbeta</span></h1> 
            ...
            <center><a href="<?php echo $link['download'] ?>" class="btn btn-large btn-success">Download Source</a></center>
            </p>
    </header>
    ...
    <div class="container-narrow"> 
      <div class="row">
        <div class="span2"></div>
          <div class="span8">
            <h3><?php echo $text_progress_staff ?>: <?php echo $progress_staff ?>%</h3>
            <div class="progress progress-striped active">
            <div class="bar" style="width: <?php echo $progress_staff ?>%;"></div>
          </div>
        </div>
      </div>
    </div>
