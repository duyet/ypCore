...
--
-- Table structure for table `yp_download_files`
--

DROP TABLE IF EXISTS `yp_download_files`;
CREATE TABLE IF NOT EXISTS `yp_download_files` (
...
--
-- Table structure for table `yp_download_list_waiting`
--

DROP TABLE IF EXISTS `yp_download_list_waiting`;
CREATE TABLE IF NOT EXISTS `yp_download_list_waiting` (
