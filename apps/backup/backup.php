<?php
require(pathinfo(__file__, PATHINFO_DIRNAME) . '/../config.php');
...
define('LIMIT', 1);
// mysql server
define('DBHOST', $ypConfig['db']['host'] . ':3306');
...
define('DBNAMES', $ypConfig['db']['dbName']);
...
define('RESTORE_CHARSET', 'utf8_unicode_ci');
